				...
				<div className="hidden lg:block">
					<div className="flex items-center justify-between py-4 text-xs text-white/90">
						<div className="flex items-center gap-4">
							<Image src={logo} alt="Logo" width={40} height={40} />
							<h1 className="text-2xl font-extrabold text-[#ca2929]">
								{COMPANY_INFO.name}
							</h1>
						</div>
						...
						<div className="flex items-center gap-2 text-white/80">
							<div className="flex items-start gap-2">
								<svg
									className="w-8 h-8 text-[#ca2929] mt-0.5 shrink-0"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24">
									<path
								...
								<div className="flex flex-col">
									<div className="text-xs uppercase tracking-wide text-[#ca2929] font-bold text-left">
										Address:
									</div>
									<div className="text-sm text-gray-800 font-bold text-left">
					...
					<div className="border border-red-700 bg-white/20 py-3 px-6 flex items-center justify-between">
						<nav className="flex items-center gap-18 ml-18 text-md text-white font-medium">
							<Link
								className="nav-link text-[#ca2929] cursor-pointer uppercase"
								href="/">
								Home
							</Link>
							<Link
