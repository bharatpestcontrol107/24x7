...
export default function StickyCallBar() {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#ca2929] shadow-2xl">
      <div className="max-w-7xl mx-auto px-3 py-3 md:px-4 md:py-4">
        ...
        >
          ...
          <div className="flex items-center gap-1 md:gap-2">
            ...
            <span className="text-xl md:text-2xl font-extrabold tracking-wide">{COMPANY_INFO.phoneDisplay}</span>
          </div>
        </a>
      </div>
    </div>
